...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LINGO PULSE — Luxury AI Voice Companion" },
      {
        name: "description",
        content:
          "Talk naturally with LINGO PULSE — a luxury AI voice companion that listens, responds, and helps you speak better English. Made in Saudi Arabia.",
      },
      { name: "author", content: "Ahmed Abu Hlail" },
      { property: "og:title", content: "LINGO PULSE — Luxury AI Voice Companion" },
      {
        property: "og:description",
        content:
          "Speak. Think. Be understood — in real, natural English. Made in Saudi Arabia 🇸🇦",
      },
